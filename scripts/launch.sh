...
powershell -NoProfile -Command "\$env:COBALT_AGENT='1'; \$env:COBALT_LOG='$LOG_LEVEL'; Start-Process -FilePath '$ROOT_W/target/debug/cobalt.exe' -RedirectStandardOutput '$ROOT_W/target/run_out.log' -RedirectStandardError '$ROOT_W/target/run_err.log'" > /dev/null 2>&1 < /dev/null
sleep 7
